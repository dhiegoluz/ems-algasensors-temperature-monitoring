...
import com.diego.algasensors.temperature.monitoring.api.model.TemperatureLogOutput;
...
import com.diego.algasensors.temperature.monitoring.domain.repository.TemperatureLogRepository;
...
public class TemperatureLogController {
    ...
    public Page<TemperatureLogOutput> search(@PathVariable TSID sensorId,
        ...
        return temperatureLogs.map(temperatureLog -> TemperatureLogOutput.
                builder().id(temperatureLog.getId().getValue())
                .value(temperatureLog.getValue())
                .registeredAt(temperatureLog.getRegisteredAt())
                .sensorId(temperatureLog.getSensorId().getValue()).build()
        );
